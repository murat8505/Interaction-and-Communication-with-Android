...
import com.example.joeroger.homework2.fragment.SnackbarFragment;
...
public class WeatherActivity extends AppCompatActivity
        ...
        SnackbarFragment.SnackbarFragmentListener,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.toggle_favorite:
                SnackbarFragment frag = (SnackbarFragment) getSupportFragmentManager().findFragmentById(R.id.snackbar_fragment);
                frag.hideSnackBar();
    ...
    public void onCityStatus(int statusMsgResId, boolean isRemoved) {
        SnackbarFragment frag = (SnackbarFragment) getSupportFragmentManager().findFragmentById(R.id.snackbar_fragment);
        frag.showSnackBar(statusMsgResId, isRemoved);
    }
