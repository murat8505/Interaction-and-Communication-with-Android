...
public class PlayServicesDialogFragment extends DialogFragment {
    ...
    public static final int PLAY_SERVICES_DIALOG_REQUEST = 1000;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return GooglePlayServicesUtil.getErrorDialog(errorCode, getActivity(), PLAY_SERVICES_DIALOG_REQUEST);
    }
