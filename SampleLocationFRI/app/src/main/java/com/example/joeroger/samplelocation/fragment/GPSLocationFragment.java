...
public class GPSLocationFragment extends Fragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Indicate keeping the fragment alive across rotation.
    ...
    public void onStart() {
        ...
        // Resend last location here, just in case a new update didn't arrive
    ...
    private void updateLocation(Location location) {
        // Since set retain instance, the listener may not exist at all times... so check for null
        if (listener != null) {
