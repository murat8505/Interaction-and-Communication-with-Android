...
public final class CityConditionsContract extends BaseContract {
    ...
    public static final String WHERE_CITY_ID_MATCHES = BaseContract.BaseWeatherColumns.CITY_ID + " = ?";
    public static final String WHERE_CURRENT_OR_FAVORITE = CityConditionsContract.Columns.CURRENT + " = ? OR " + CityConditionsContract.Columns.FAVORITE + " = ?";
    public static final String[] WHERE_CURRENT_OR_FAVORITE_ARGS = new String[] { "1", "1" };
    ...
    /* package */ static final String CREATE_TABLE =
            "CREATE TABLE " + TABLE + " ( " +
                    ...
                    Columns.CURRENT + " INTEGER DEFAULT 0, " +
