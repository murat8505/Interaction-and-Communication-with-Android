...
import com.example.samplebackgroundnetworking.network.CacheUtils;
import com.example.samplebackgroundnetworking.network.ConnectivityUtils;
import com.example.samplebackgroundnetworking.provider.Seattle911Contract;
...
class FetchDataHelper {
    ...
    public static void loadData(Context context, DelayAndRetryHandler handler) {
        ...
        try {
            ...
            if (lastFetch.getTime() > System.currentTimeMillis() - TWO_HOURS) {
