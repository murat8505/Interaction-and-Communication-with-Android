package com.example.samplebackgroundnetworking.network;

import android.app.AlarmManager;
import android.content.Context;
import android.util.Log;

import com.example.samplebackgroundnetworking.receiver.AlarmBroadcastReceiver;
...
public class AlarmUtils {
    ...
    private static final long ALARM_DELAY = TWELVE_HOURS; //FOUR_MINUTES;
