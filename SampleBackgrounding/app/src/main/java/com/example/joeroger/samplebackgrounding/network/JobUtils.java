...
import com.example.joeroger.samplebackgrounding.service.NetworkAsyncJobService;
import com.example.joeroger.samplebackgrounding.service.NetworkHandlerJobService;
...
public class JobUtils {
    ...
    public static void scheduleJob(Context context) {
        ...
        newJob = buildHandlerJobInfo(context);
        result = jobScheduler.schedule(newJob);
        if (result == JobScheduler.RESULT_FAILURE) {
